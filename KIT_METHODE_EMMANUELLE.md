...
Pas une formation théorique. Une méthode concrète + 2 outils IA pour :

1. **Te rendre visible** auprès des bonnes personnes (tes posts + tes commentaires)
2. **Créer du lien** sans avoir l'impression de "déranger"
3. **Transformer ce lien en conversations** qui amènent des clients
...
- Tu récoltes des infos en or pour affiner ton offre
- Et naturellement, certaines personnes vont te dire "tiens, justement, j'ai ce problème" → là, la porte s'ouvre toute seule

**La carte que tu vas jouer : l'honnêteté.**
...
## PARTIE 2 — TES 3 LEVIERS

### LEVIER 1 — TES POSTS (tu attires)

Objectif : que les bonnes personnes (indépendants débordés) te voient, se reconnaissent, et se disent "elle a compris mon problème".

**La règle d'or :** tes posts parlent des DOULEURS de ta cible, pas de toi.
...
### LEVIER 2 — TES COMMENTAIRES (tu te rends visible + tu crées du lien)

C'est ton meilleur outil de warming. Tu commentes les posts de tes prospects → ils te remarquent → quand tu leur écris ensuite, t'es plus une inconnue.

**Ton blocage actuel :** tu plafonnes à 5 commentaires/jour parce que tu dois lire le post, trouver un truc intéressant à dire, et c'est là que ça coince.

**La solution :** le skill Commentaires (fichier `SKILL_COMMENTAIRES_EMMANUELLE.md`). Tu lui colles le post → il te donne **l'idée, l'angle** (un insight profond et concret). Pas le commentaire tout fait : juste le déclic. Toi tu l'écris en 2-3 phrases avec tes mots, ton ton, ton humour.
...
### LEVIER 3 — L'APPROCHE DIRECTE HONNÊTE (tu crées la conversation)

Une fois que t'as commenté quelqu'un et qu'il y a eu un petit échange, tu peux aller en message privé. Pas pour pitcher. Pour comprendre.
...
2. "Si tu pouvais déléguer UNE seule tâche admin demain, ce serait laquelle ?"

**Ce que tu fais ensuite :**
- Tu écoutes vraiment. Tu rebondis humainement.
- Si la personne dit que ça la soûle / lui prend un temps fou → tu creuses un peu : "ça te prend combien d'heures par semaine à peu près ?"
...
## PARTIE 3 — TA ROUTINE (concrètement)

Commence petit pour tenir dans la durée. Mieux vaut 30 min/jour tous les jours qu'une grosse session une fois et plus rien.

**Chaque jour (30-45 min) :**
...
- Tu relis ta data récoltée : qu'est-ce qui revient ? Quelles douleurs ? Ça affine ton offre ET ça repère tes meilleurs prospects.

---

## PARTIE 4 — TES 2 OUTILS IA
