...
- Statut : Phase 3 avancée, pattern confirmé — le ghosting post-devis est spécifique à Malt, pas à son activité en général
- Dernier point : dev WordPress passionnée de backend, 3 clients actifs (au 10/07), sourcing bouche-à-oreille + Malt occasionnel (évité à cause de la concurrence à prix cassés). Le devis du lead chaud (référence familiale, mockup envoyé, cliente qui l'avait rappelée dans la foulée) a bien été envoyé mais décision reportée à septembre (elle part en vacances en août). Second cas plus frustrant : devis Malt envoyé début juillet, relancé deux fois, zéro réponse — elle confirme que c'est "régulier" sur Malt spécifiquement, qu'elle attribue à la concurrence par le prix (le client prend le moins cher) mais juge qu'un minimum de réponse serait dû ("c'est la moindre des choses")
- Patterns utilisés : Règle 6 (quantification, cas de référence documenté — a aussi servi de contre-exemple pour la Règle 7), Règle 1 (rebond mots exacts), forme "callback running gag co-créé" (relance du 27/07, réussie), Règle 14 (signal marché sur le ghosting post-devis). Réponse au 27/07 (09:59) = Règle 3 (valider que le minimum de courtoisie serait légitime) + Règle 11 (pattern-linking : contraste entre ses leads Malt qui ghostent et son lead bouche-à-oreille qui l'a rappelée immédiatement — question, pas affirmation, pour la laisser identifier elle-même la différence de qualité entre les deux canaux)
- Prochaine étape probable : si elle identifie que le bouche-à-oreille/réseau convertit mieux que Malt, ça confirme/renforce sa stratégie actuelle (déjà "très rarement Malt") — voir si ça ouvre une réflexion sur where investir son temps de prospection
- Dernière mise à jour : 27 juillet 2026
