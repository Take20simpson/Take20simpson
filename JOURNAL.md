...
- Stats : pas encore publié.
- Notes : reste à choisir l'approche finale avec Matthias. Distinct de PA-1 Angle 4 (le bouche-à-oreille amplifie le feast-or-famine, déjà dans le catalogue) — angle différent ici (chance vs compétence, misattribution), pas un doublon.
