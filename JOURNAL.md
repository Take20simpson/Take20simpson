...
- **Point de préparation ajouté (visio Yann, 10 septembre 2026) :** prix de sa formation encore inconnu, à demander en priorité en call — stratégie totalement différente selon le tarif (low ticket, environ <200-300€ : setting complet peu rentable, mieux vaut pub/contenu ; high ticket, probablement le cas ici selon l'intuition de Matthias vu que c'est une certification pro : setting pertinent). Sur la volonté de faire porter le setting par son frère : creuser "pourquoi tu as quand même pris cet appel si ton frère peut le faire ?" plutôt que "comment le former" — le doute qu'elle a elle-même sur cette solution interne est le vrai signal. Demander aussi les résultats concrets déjà obtenus par le frère en prospection (pas juste "un peu d'expérience"). Si confirmation low ticket, consulter Alban (expert prospection de l'équipe Yann) sur la stratégie adaptée avant le call.
