...
- **Objectif de l'appel : vendre sa formation MASE (+ la communauté associée), pas ses services d'accompagnement/audit.** Toute la conversation juste avant le call obtenu porte sur ce sujet : elle a déjà vendu la formation et la communauté une fois chacune mais n'a aucun système pour vendre plus, aucune routine de setting/prospection ("je m'y prends pas"). Rien dans l'échange n'évoque un besoin sur son activité MASE core (accompagnement/audit), déjà full et rentable.
...
- Objectifs long terme (donnés spontanément, en cascade à la question de Matthias) :
  ...
  2. Formation en ligne MASE — c'est l'objectif du call (voir ci-dessus) : déjà créée et déjà vendue une fois, elle veut maintenant la vendre en volume.
...
- **Le vrai sujet business actuel, à bien distinguer de l'activité MASE core (saine et stable) : sa nouvelle offre formation + communauté MASE (lives d'expert, forum, réponses aux questions).** Déjà vendue une fois chacune ("j'ai de la traction ... faut juste que je termine et que je vende plus"). Plan de distribution : la formation sera incluse dans l'accompagnement (le client bosse, elle corrige, gain de temps pour elle) ; aux anciens clients d'audit interne, elle compte vendre soit la formation seule soit la communauté. Canal envisagé par elle-même, spontanément : "posts LinkedIn, refaire un lead magnet, faire du setting, et prospecter un peu."
...
- **Point de préparation ajouté (visio Yann, 10 septembre 2026) :** prix de sa formation encore inconnu, à demander en priorité en call — stratégie totalement différente selon le tarif (low ticket, environ <100-200€ non récurrent : setting complet peu rentable, mieux vaut pub/contenu ; high ticket : setting pertinent). Hypothèse de Matthias, non confirmée : plutôt 1000-1500€, vu que c'est une certification pro. Nuance apportée le 11 septembre (relecture transcript complet de la visio) : la communauté (abonnement mensuel) peut rester pertinente pour le setting même à tarif bas si récurrente longtemps — LTV ~3000-4200€ sur ~2 ans de rétention à ~150€/mois, c'est la LTV qui compte, pas le prix affiché — donc demander la structure de prix (mensuel vs unique) pour la formation ET pour la communauté séparément. Sur la volonté de faire porter le setting par son frère : creuser "pourquoi tu as quand même pris cet appel si ton frère peut le faire ?" plutôt que "comment le former" — le doute qu'elle a elle-même sur cette solution interne est le vrai signal. Demander aussi les résultats concrets déjà obtenus par le frère en prospection (pas juste "un peu d'expérience") ; d'après Matthias le frère est freelance généraliste, pas spécialiste prospection. Si confirmation low ticket sans potentiel récurrent, consulter Alban (expert prospection de l'équipe Yann) sur la stratégie adaptée avant le call.
