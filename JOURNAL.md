...
- Statut : Phase 4, creusage de croyance limitante en cours ("écrit" vs "commercial")
- Dernier point : activité lancée il y a environ 1 mois (fin juin), issue du salariat ("j'ai tenu 5 ans avec un job par an et j'ai fini par péter un câble"), reconvertie de la rédaction web au ghostwriting après avoir vu ses propres posts bien marcher dans son ancien job. Après avoir réaligné son offre (révélé le 15/07), ses nouveaux calls n'ont toujours pas closé — mais elle a pris l'initiative d'enregistrer ses calls et de repérer elle-même ses erreurs. Séquence de creusage sur sa croyance limitante (Principe #8) : "pas avoir les réflexes commerciaux directement" → "je suis plus à l'aise sur mon clavier qu'en commercial" → généralisation défensive ("ça dépend des gens") → précisée : "à l'écrit ça ne me demande aucun effort, à l'oral beaucoup d'énergie". Elle décrit une vraie différence de fluidité, pas juste une excuse — mais sans distinguer si c'est inné ou lié au temps de pratique (elle écrit depuis des années dans son ancien job, l'oral commercial elle le pratique depuis 1 mois)
- Patterns utilisés : Règle 6 (quantification, relance du 13/07), Règle 15 (auto-partage bac/lancement), forme "auto-dérision sur la platitude de sa propre réponse précédente" (relance du 27/07, réussie), Règle 11 (pattern-linking offre/commercial). Réponse au message du 27/07 (09:57) = Règle 7 (rondeur plus substantielle cette fois — 4e question de creusage consécutive sur ce sujet, risque d'interrogatoire à surveiller) + Règle 2 (ne pas affirmer que c'est "juste une question de pratique", poser la question qui fait émerger si son aisance à l'écrit est innée ou construite avec le temps)
- Prochaine étape probable : si elle réalise que l'aisance à l'écrit s'est construite avec la pratique (pas innée), ça ouvre la porte à Principe #8 et potentiellement Règle 9 (ramener vers l'offre/le framework) — sinon continuer à creuser cette croyance identitaire sans forcer, en espaçant les questions pour ne pas sur-creuser (Règle 7)
- Dernière mise à jour : 27 juillet 2026
