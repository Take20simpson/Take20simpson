...
**Journal Prospection — une entrée par prospect :**
```
### [Prénom Nom] — [headline courte]
- Statut : [phase actuelle / étape]
- Dernier point : [résumé du dernier échange, 1-3 lignes]
- Patterns utilisés : [règles/mécaniques employées de SKILL_SETTING_DM.md]
...
- Statut : Phase 3-4 avancée, rapport excellent mais qualification stable et faible sur 2 des 3 signaux — **état des lieux fait le 24 juillet suite à une demande explicite de Matthias**, voir verdict ci-dessous
- Dernier point : indépendante depuis 3 ans (ex-16 ans cabinet audit/expertise comptable, 1er business peinture chaussures/textiles), 100% bouche-à-oreille + LinkedIn comme vitrine plus que canal d'acquisition. A eu son 1er vrai creux en 3 ans (déjà résolu), cause identifiée par elle-même (clients pas alignés sur la facturation) et déjà corrigée. A révélé un incident frais mais confirmé isolé (prospect perdu face à une concurrente qui "sonnait plus experte"). A affirmé fort son identité de communication (calme, expérience, optimisme, refuse de se travestir). Dernière réponse : la confiance avec un nouveau prospect est immédiate "parce que c'est comme LinkedIn je pars du principe que si les choses doivent se faire elles se feront".
- **Verdict état des lieux (24 juillet) :** sur 3 tentatives distinctes et bien ciblées de faire émerger de la douleur/urgence (le creux passé, l'incident du prospect perdu, la confiance avec un nouveau prospect), elle retombe systématiquement sur le même socle — sereine, à son rythme, "les choses se feront si elles doivent se faire". Ce n'est pas de l'esquive tactique qui craquerait sous plus de quantification : c'est une philosophie de vie/business authentique et stable chez elle (fatalisme optimiste), confirmée trois fois sur trois sujets différents. Signal Urgence 🔴 jugé stable, peu de chances de bouger par plus de questions aujourd'hui. Signal Douleur 🔴-🟡, rien d'assez aigu pour un appel maintenant. Signal Maturité 🟢 seul acquis. Elle a montré un intérêt réel pour l'offre plus tôt ("j'aimerais vraiment me l'offrir, c'est primordial") mais gaté par "step by step" — jamais retraité depuis, et la propre réponse de Matthias à l'époque ("aucune urgence de mon côté") a plutôt entériné le non-rush que ouvert un chemin vers un timing.
- **Recommandation (24 juillet) :** ne pas insister davantage aujourd'hui sur le creusage — continuer forcerait contre une conviction stable, pas une défense fragile, et risquerait de commencer à sonner comme du forcing (exactement ce qu'elle a dit détester chez d'autres prospecteurs, Règle "objection précoce"). Referme la conversation du jour sur une note chaleureuse et légère, sans nouvelle question de fond ni pitch. Planter une graine légère si l'occasion se présente naturellement plus tard, sinon laisser reposer et revenir dans 3-4 semaines avec un angle frais (nouveau creux, nouvelle perte de prospect, ou contenu qui retouche le sujet différenciation) plutôt que de retraiter les mêmes sujets déjà explorés à fond
- Patterns utilisés : Règle 13 (teasing, plusieurs occurrences), Règle 14 (signal marché), Règle 3/7 (validation + rondeur longue abondante), Règle 6 (quantification, a confirmé l'incident comme isolé), rapprochement silencieux amorcé
- Corrections/confirmations capturées en session (24 juillet) : pattern-linking jugé trop direct après une pirouette humoristique → nuance ajoutée à `SKILL_SETTING_DM.md` Règle 11 ; "enrobage parfait" (rondeur + teasing + question) validé → capturé dans `TEASING_METHODE_DM.md` Partie 7
- **Suite du fil (26 juillet) :** Matthias a bien fermé comme recommandé — message chaleureux et léger, pas de nouvelle question de fond ("j'aime bien ta philosophie, ce côté si ça doit se faire ça se fera, y'a un vrai truc sain là-dedans"). Pas encore de réponse de Marie.
- **Nouveau signal externe (27 juillet) — sondage LinkedIn "C'est quoi ton mois en ce moment ?" (post SA-1, croyance centrale) :** Marie a voté "sec, zéro visibilité" et a commenté sous le sondage : **"Maaaais toujours dans le positif 👀"**. **Lecture confirmée :** sur toute la conversation DM, sa seule frustration récurrente et répétée (revenue 3 fois : 6/7, 13/7, 24/7) porte sur les impressions/visibilité de ses propres posts (86-100 vues max) — jamais sur un manque de clients ou de CA, qu'elle décrit comme stable (bouche-à-oreille, creux résolu, sereine). Le commentaire confirme noir sur blanc le pattern déjà documenté : même en votant l'option la plus négative, elle l'enrobe immédiatement de son registre calme/optimiste habituel (fatalisme optimiste, "je prends tout du bon côté"). Le vote/commentaire lit donc comme "mon contenu ne perce pas, mais je le vis bien" — pas comme un cri d'alarme business. Ça reste une frustration réelle et exploitable en teasing, mais ce n'est pas la douleur business aiguë qui manquait pour qualifier une visio : l'offre de Matthias c'est de la prospection directe (Croyance Centrale, `SKILL_STRATEGIE.md` Partie 2), pas de la croissance de contenu/algorithme.
- **Décision prise en session (27 juillet) :** plutôt que de relancer en DM, Matthias rebondit dans le fil de commentaires sous le sondage, en réponse à son "Maaaais toujours dans le positif 👀" — canal plus doux, cohérent avec Principe #1 (ne jamais montrer le besoin) et avec le fait qu'elle vient de fermer le DM sur une note calme. Message envoyé (Situation 6bis, `SKILL_SETTING_DM.md`) : rebond humoristique sur ses mots exacts + demande d'un exemple concret ("y'a pas eu UN moment cette semaine où t'as regardé tes vues en mode sérieux là ?").
- **Résultat (27 juillet) :** Marie a répondu "j'ai abandonné le sujet des vues 🤣" — encore de l'humour, aucun exemple concret nommé, elle esquive même la piste douce. **Lecture mise à jour :** ce n'est plus seulement une conviction stable côté business qu'elle enrobe de calme — elle a explicitement décroché du sujet visibilité aussi (elle ne le suit même plus, elle n'encaisse pas juste avec sérénité). Les deux pistes de douleur identifiées (business/creux et visibilité/vues) sont neutralisées aujourd'hui, aucune n'est exploitable dans l'immédiat.
- **Recommandation :** fermer chaleureusement le fil de commentaire ici (rire avec elle, pas de nouvelle question), ne pas insister davantage cette semaine. Mettre le prospect de côté — revenir seulement sur un signal frais et non sollicité (nouveau creux business, nouvelle frustration content clairement exprimée d'elle-même), pas de relance proactive avant ça.
- Prochaine étape probable : aucune relance active. Rester en veille passive (likes/engagement léger si elle poste), reprise seulement sur signal spontané.
...
- Patterns utilisés : Règle 13 (teasing, réciprocité directe répétée), Règle 1 (rebond sur ses mots exacts)
- Prochaine étape probable : creusage à amorcer sur sa propre méthode/positionnement une fois sa réponse reçue — profil pas clairement ICP (paire potentielle plus que prospect en douleur), à requalifier
...
- Patterns utilisés : relance du 27/07 = forme "meta-commentaire sur la conversation elle-même" (réussie, `TEASING_METHODE_DM.md` Partie 8 point 8) — assumer avec humour la dérive 100% emoji plutôt que l'ignorer, puis reprendre une vraie question business ancrée sur son rythme estival déjà connu. Elle a réagi avec humour ("il faut arrêter maintenant hein") sans répondre à la question business — relance légère du 27/07 (même tour) = rebondir sur son mot exact ("arrêter") tout en réinvitant la réponse, toujours une seule question
...
- Prochaine étape probable : si elle répond enfin sur son rythme d'été/rentrée, rester en registre léger — pas de creusage business tant qu'aucun vrai signal de douleur n'apparaît (elle a explicitement une méthode contenu/réseau qui fonctionne pour l'instant)
- Dernière mise à jour : 27 juillet 2026
...
### Julie Pinter — Prête-plume pour CEOs, +2M d'impressions
- Statut : Phase 4 en pause (fil business jamais refermé), reprise de contact spontanée côté Julie le 21 août sur un sujet contenu — à réenclencher vers le business
- Dernier point : activité lancée fin juin, issue du salariat ("j'ai tenu 5 ans avec un job par an et j'ai fini par péter un câble"), reconvertie de la rédaction web au ghostwriting après avoir vu ses propres posts bien marcher dans son ancien job. Séquence de creusage Phase 4 (Principe #8, croyance identitaire écrit/oral) close sans ouverture le 27/07 : à la question de savoir si son aisance à l'écrit était innée ou construite avec le temps, elle a tranché "Non c'est le cas depuis toujours" — l'hypothèse "c'est juste une question de pratique" ne tient pas pour elle, la porte espérée vers Principe #8 ne s'est pas ouverte comme prévu. Réponse de Matthias à cette précision : "Top" seul, encore un accusé de réception pur (5e occurrence du pattern signalé plus bas). Le 29/07, Matthias lui propose un groupe d'entraide engagement LinkedIn (gratuit puis payant) — elle décline, révélant en passant "j'ai énormément de visibilité" (donnée notable : à cette date, ses calls clients n'avaient toujours pas closé — cf. 27/07 "Pas de oui"). Silence ensuite jusqu'au 21 août, où **c'est elle** qui relance spontanément pour complimenter les nouveaux posts de Matthias et repérer un changement de stratégie ("t'as changé quelque chose dans ta strat non?", puis "tu mets plus de ta personnalité dans tes posts"). Matthias a répondu avec une question ouverte ("c'est quoi qui t'a interpellé ?") mais a refermé l'échange le 22/08 sur "Oui c'est possible ahah" sans rien relancer — fil de nouveau en pause côté Matthias depuis.
- Patterns utilisés : Règle 6 (quantification, relance du 13/07), Règle 15 (auto-partage bac/lancement), forme "auto-dérision sur la platitude de sa propre réponse précédente" (relance du 27/07, réussie), Règle 11 (pattern-linking offre/commercial), R12 (posture d'offreur nette sur le refus du groupe — "ok ça marche", zéro insistance)
- **Pattern récurrent (5e-6e occurrence sur ce lot, jamais formellement tranché dans `SKILL_SETTING_DM.md`)** : accusés de réception purs ("Top", "Oui c'est possible ahah") juste après une info exploitable (précision sur la croyance identitaire le 27/07 ; compliment + observation fine sur le contenu le 22/08) — même pattern que Amanda/Charlotte/Marine déjà signalé plus haut dans ce journal
- **Rapprochement silencieux disponible pour la relance :** elle a dit avoir "énormément de visibilité" (29/07) mais aucune confirmation depuis qu'un call a été closé (dernier statut connu, 27/07 : toujours pas de oui) — angle naturel pour la prochaine question sans jamais nommer l'écart
- Prochaine étape probable : réenclencher (message resté sans suite depuis le 22/08) en repartant du sujet qu'elle a elle-même ouvert (contenu/personnalité), puis pivoter en une question vers le fil business resté ouvert (closing des calls) — rapprochement silencieux possible avec "énormément de visibilité"
- Dernière mise à jour : 30 août 2026

**Pattern récurrent signalé à Matthias (3e occurrence sur ce lot, avant validation de la proposition de règle) :** Amanda Cascino ("tiens-moi au courant" après reveal coaching), Charlotte Dimpre ("Ah ok cool" sur sa réciprocité), Julie ("👍" après un diagnostic business très exploitable) — voir aussi Marine Vonner (4e occurrence). Proposition en attente de validation : ajouter à `SKILL_SETTING_DM.md` Partie 8 un point sur les accusés de réception purs après une révélation exploitable.

### Marine Vonner — Communication | Marketing | Événementiel
- Statut : Phase 3-4, conversation abandonnée après une révélation de désqualification claire — relance en cours le 27/07 (Situation 10bis)
- Dernier point : prospect identifiée comme "braquable" sur les questions personnelles directes (sa question parcours du 1/06 n'a jamais eu de réponse). Le pivot "question d'opinion" du 13/07 (contenu vs prospection, Situation 3bis) a très bien fonctionné — délivré en TEXTE cette fois et non en vocal comme initialement recommandé (`TEASING_METHODE_DM.md` Partie 4.4), mais efficace quand même : elle s'est engagée dans un échange long et réfléchi, avec réciprocité directe de sa part ("Et toi qu'est-ce qui te rapporte le plus ?"). Matthias a bien teasé en retour (Règle 13, mix quantité+intention) et creusé sur son rythme. Réponse finale de Marine : **révélation de désqualification** — elle a ralenti son activité freelance parce qu'elle cherche activement un poste stable en CDI, son énergie va là-dessus, le développement business n'est pas sa priorité actuelle (mais elle reste ouverte, entretient son réseau "on ne sait jamais"). Réponse de Matthias à cette révélation majeure : encore un "👍" seul, rien de plus.
- Patterns utilisés : Situation 3bis (question d'opinion, réussie malgré la livraison en texte plutôt qu'en vocal), Règle 13 (teasing réciproque), Règle 6 (quantification sur le rythme). Relance du 27/07 = forme "affirmation de care + question personnelle légère, sans push business" (septième forme du lot, `TEASING_METHODE_DM.md` Partie 8 point 8) — réagir avec une vraie chaleur sincère à sa recherche de CDI plutôt qu'ignorer ou forcer un retour vers la qualification freelance
- **Pattern récurrent, 4e occurrence dans ce lot de relances (Amanda, Charlotte, Julie, maintenant Marine) :** une réponse très courte/passive de Matthias ("👍", "Ah ok cool", "tiens-moi au courant") coupe systématiquement l'élan juste après une révélation riche du prospect. Proposition à valider par Matthias, pas encore capturée dans `SKILL_SETTING_DM.md` : ajouter à la Partie 8 (checklist) un point du type "avant d'envoyer un accusé de réception pur (👍, emoji seul, 'ok cool'), vérifier si le prospect vient de révéler une info exploitable — si oui, jamais un accusé de réception seul, au minimum une réaction + une question ou une affirmation de suivi"
- Qualification : signal de désqualification clair pour l'offre actuelle (elle priorise un retour au salariat, pas la croissance freelance) — ne pas pousser de creusage business/qualification tant que ce cap n'a pas changé (Principe #1, ne jamais montrer le besoin ; pas de forcing). Garder le rapport chaleureux, revenir seulement si elle signale elle-même un nouveau signal (retour à l'activité freelance en priorité)
- Prochaine étape probable : rester en registre chaleureux/personnel, aucune pression de qualification tant qu'elle reste orientée CDI
- Dernière mise à jour : 27 juillet 2026

### Florence Androlus — Développeur WordPress Freelance, expert plugins & APIs
- Statut : Phase 4, nouvelle croyance limitante révélée (peur du téléphone) — n'a pas répondu au pattern-linking Malt/bouche-à-oreille, a dévié vers un aveu plus personnel
- Dernier point : dev WordPress passionnée de backend, 3 clients actifs (au 10/07), sourcing bouche-à-oreille + Malt occasionnel (évité à cause de la concurrence à prix cassés). Le devis du lead chaud (référence familiale) reporté à septembre. Devis Malt ghosté après plusieurs relances écrites — mais elle révèle qu'elle a en fait le numéro de téléphone du client (il lui avait écrit) et n'a "pas osé l'appeler". Elle a une option d'action concrète disponible qu'elle n'utilise pas, par appréhension plutôt que par manque de moyen
- Patterns utilisés : Règle 6, Règle 1, Règle 14 (signal marché), Règle 11 (pattern-linking Malt/bouche-à-oreille, pas encore répondu). Réponse au 27/07 (10:03) = Règle 7 (valider/normaliser la peur du téléphone, très courante, avant de creuser) + Règle 4 (identifier ce qui la retient précisément, via une question, pas une affirmation du type "il faut juste appeler")
- Prochaine étape probable : si elle identifie la peur précise (rejet à l'oral, sonner désespérée, etc.), voir si ça résonne avec une croyance plus large sur la prospection active — matière potentielle pour Règle 9 si une vraie prise de conscience arrive
- Dernière mise à jour : 27 juillet 2026

### Virginia Prat (Miss Office) — Bras droit / assistante indépendante, +15 ans d'expérience
- Statut : Phase 5 passée (visio proposée le 10/06, déclinée poliment car déjà engagée ailleurs) — désormais hors ICP actif mais relation très chaleureuse à entretenir — relance en cours le 27/07 (Situation 10bis)
- Dernier point : lancée fin avril 2026, creusage Enzo complet mené fin mai/début juin (parcours, quantification 20 conversations/0 client au début, diagnostic timing, partage volontaire d'une vraie conversation prospect — Lucien Arbieu — à la demande de Matthias, feedback détaillé via plusieurs vocaux sur cette conversation). Matthias a proposé une visio le 10/06 — déclinée le 11/06 car elle avait déjà un rdv pour un accompagnement plus large ailleurs (offre/positionnement/prospection), avec une porte laissée ouverte ("si le feeling n'y est pas, je reviendrai"). Confirmé le 15/06 que le feeling est bon avec ce concurrent. Reconnexion chaleureuse le 10/07 via des échanges en commentaires (humour/absurde, running gag "vraie plume"). Relance du 13/07 sur sa promesse de nouvelles a très bien marché : elle a révélé 2 propositions de contrat en attente de signature, attribuées à la fois à son accompagnement en cours ET à sa prospection/visibilité — en particulier "ma façon d'écrire les messages" (ce qui valide indirectement les conseils gratuits donnés par Matthias en amont sur sa conversation avec Lucien Arbieu). Dernier message de Matthias : validation chaleureuse mais sans question, conversation refermée sur une bonne note. Silence depuis (14 jours).
- Patterns utilisés : Règle 6 (quantification complète, cas riche), Règle 8 (faire vivre le coaching, feedback sur sa vraie conversation), Situation 11 (proposition de visio), Situation 2/9 (déclinée poliment, gérée sans besoin ni critique du concurrent — Principe #2 respecté). Relance du 27/07 = curiosité sur l'issue des 2 contrats, formulée avec une image légère ("salle d'attente") pour éviter de reprendre littéralement le phrasé déjà utilisé sur Amanda (forme 3)
- Qualification : désqualifiée pour l'offre actuelle — accompagnement concurrent déjà en cours et efficace, aucun besoin actif. Relation à entretenir en pur mode chaleureux/sans agenda (Principe #1), aucune tentative de repositionner l'offre tant qu'elle ne signale pas elle-même un manque
- Prochaine étape probable : si elle répond sur les contrats, féliciter sincèrement et rester dans le registre léger/humour déjà établi — aucun creusage business, ce n'est plus pertinent ici
- Dernière mise à jour : 27 juillet 2026
...
- Patterns utilisés : Règle 13 (teasing, réciprocité directe), varier la formulation par rapport au tease précédent dans la même conversation
...
### Maeva Mintz — Experte MASE, obtention certification & réduction accidentologie (30+ audits réalisés/an)
- Statut : Phase 1-2 avancée (contact chaleureux + qualification business déjà bien renseignée), call obtenu — prévu le 15 septembre 14h-14h45 (Google Meet). Conversation menée par Matthias directement (post-31 août, méthode Yann, hors moteur IA `SKILL_SETTING_DM.md`).
- **Objectif de l'appel : vendre sa formation MASE, pas ses services d'accompagnement/audit.** Correction de Matthias (15 septembre 2026, précise la correction du 14) : ce qu'elle vend, c'est sa formation — la communauté est une feature à l'intérieur, pas un second produit. On ne parle plus de "package" (terme abandonné), le terme principal est "formation". Elle l'a vendue une fois (pas "une fois chacun"). Toute la conversation juste avant le call obtenu porte sur ce sujet : elle a déjà vendu sa formation une fois mais n'a aucun système pour vendre plus, aucune routine de setting/prospection ("je m'y prends pas"). Rien dans l'échange n'évoque un besoin sur son activité MASE core (accompagnement/audit), déjà full et rentable.
- Ce qu'elle fait : indépendante MASE (référentiel sécurité BTP/industrie). Deux activités : (1) accompagnement/certification MASE, clients trouvés en direct sur LinkedIn ; (2) audits — passe obligatoirement par 2 cabinets d'audit agréés pour la certification (ne peut pas exercer en direct), + audits internes reçus des mêmes cabinets et d'un réseau de consultants MASE (renvoi mutuel de missions accompagnement ↔ audit selon la spécialité de chacun). Business déjà très établi : accompagnement "full" (plus de dispo), seulement 3-4 jours dispo en audit d'ici fin d'année, CA de l'année déjà largement atteint ("j'ai large mon CA de l'année", ne se soucie même pas de remplir les 3-4 jours restants). Business jugé par elle-même récurrent et en croissance naturelle sur 2-3 ans sans effort supplémentaire.
- Objectifs long terme (donnés spontanément, en cascade à la question de Matthias) :
  1. Réseau de consultants en sous-traitance pour livrer les accompagnements sur toute la France — elle sort elle-même de la delivery (aujourd'hui elle fait tout en direct, elle est full) pour passer en pilotage.
  2. Formation en ligne MASE (avec communauté intégrée) — c'est l'objectif du call (voir ci-dessus) : déjà créée et déjà vendue une fois, elle veut maintenant la vendre en volume.
  3. D'ici 3 ans, faire agréer sa propre boîte comme cabinet d'audit agréé — aujourd'hui elle doit obligatoirement passer par 2 cabinets tiers pour délivrer les certifications, elle veut supprimer cet intermédiaire.
- **Le vrai sujet business actuel, à bien distinguer de l'activité MASE core (saine et stable) : sa formation MASE, avec une communauté intégrée comme feature (lives d'expert, forum, réponses aux questions) — pas un second produit distinct.** Déjà vendue une fois ("j'ai de la traction ... faut juste que je termine et que je vende plus"). Plan de distribution : la formation sera incluse dans l'accompagnement (le client bosse, elle corrige, gain de temps pour elle) ; aux anciens clients d'audit interne, elle compte vendre soit la formation seule soit l'accès à la communauté. Canal envisagé par elle-même, spontanément : "posts LinkedIn, refaire un lead magnet, faire du setting, et prospecter un peu."
- **Setting/prospection : signal qualifiant très net pour l'offre de Matthias.** Elle admet directement n'avoir aucune routine ("pour l'instant je m'y prends pas 😂"). A testé des lead magnets génériques (quarts d'heure sécu) : beaucoup de téléchargement, quasi aucun engagement réel ensuite — elle en tire elle-même la conclusion qu'il lui faut un lead magnet plus ciblé. Ne sait pas comment aborder les conversations ensuite. **Ne connaissait pas le mot "setting" à l'époque de son accompagnement avec Julien Guy** (c'est dans ce contexte-là qu'elle le dit, pas Matthias qui le lui aurait appris — à ne pas mal attribuer).
- **Info donnée directement par Matthias (issue des vocaux échangés, non retranscrits dans le texte) : elle veut travailler en famille et déléguer la partie setting à son frère, freelance.** Élément important à garder pour le call — si elle veut faire porter le setting par un tiers (son frère) plutôt que le faire elle-même, ça change qui doit être formé/accompagné sur cette partie de l'offre, à clarifier avec elle.
- Historique setting/vente : accompagnée avant par un certain "Julien Guy" sur prospection/vente téléphonique — "avait pas trop donné", mais elle attribue elle-même l'échec à l'absence d'offre claire à l'époque + au fait de ne pas y avoir mis d'énergie + à son propre manque de confiance dans la valeur de ce qu'elle proposait (aucune critique de la méthode elle-même). Point à vérifier en call : ces trois freins (offre floue / énergie / confiance) sont-ils vraiment levés aujourd'hui sur la formation/communauté ?
- Éléments encore manquants pour qualifier pleinement côté avatar "Lucas" (`STRATEGIE_YANN.md`) : volume d'audience LinkedIn réel non donné dans cet échange ; aucune donnée budget/investissement abordée (le "j'ai large mon CA" est un signal financier positif fort mais indirect, à confirmer) ; format prévu pour la formation/communauté (prix, structure) pas détaillé ici.
- Patterns utilisés : Phase 1 (prétexte de contact réel — compliment sincère + anecdote personnelle vérifiable), Phase 2 (qualification en cascade, jamais de question fermée avant d'avoir isolé le sujet business) — `METHODE_SETTING_YANN.md`. Plusieurs vocaux envoyés par Matthias non retranscrits (contenu non connu).
- Prochaine étape probable : préparer le call du 15 septembre avec Yann en gardant le focus sur la vraie douleur (vendre la formation/communauté, pas l'activité MASE core qui va bien) — creuser en call le budget, le volume d'audience, et si les 3 freins passés (offre/énergie/confiance) sont bien résolus aujourd'hui.
- **Point de préparation ajouté (visio Yann, 10 septembre 2026) :** prix de sa formation encore inconnu, à demander en priorité en call — stratégie totalement différente selon le tarif (low ticket, environ <100-200€ non récurrent : setting complet peu rentable, mieux vaut pub/contenu ; high ticket : setting pertinent). Hypothèse de Matthias, non confirmée : plutôt 1000-1500€, vu que c'est une certification pro. Nuance apportée le 11 septembre (relecture transcript complet de la visio) : un tarif bas peut rester pertinent pour le setting si récurrent longtemps — LTV ~3000-4200€ sur ~2 ans de rétention à ~150€/mois, c'est la LTV qui compte, pas le prix affiché. **Correction du 15 septembre (Matthias, précise celle du 14) : ce qu'elle vend, c'est sa formation — la communauté est une feature à l'intérieur, pas un second produit. Terme "package" abandonné, terme principal = "formation".** Une seule question de prix à poser (celle de la formation dans son ensemble). Vérifier en call si l'accès à la communauté est ponctuel (inclus dans la formation) ou implique un abonnement récurrent, pour appliquer ou non la nuance LTV ci-dessus. Sur la volonté de faire porter le setting par son frère : creuser "pourquoi tu as quand même pris cet appel si ton frère peut le faire ?" plutôt que "comment le former" — le doute qu'elle a elle-même sur cette solution interne est le vrai signal. Demander aussi les résultats concrets déjà obtenus par le frère en prospection (pas juste "un peu d'expérience") ; d'après Matthias le frère est freelance généraliste, pas spécialiste prospection. Si confirmation low ticket sans potentiel récurrent, consulter Alban (expert prospection de l'équipe Yann) sur la stratégie adaptée avant le call.
- Dernière mise à jour : 15 septembre 2026

### Léni Mette — Étudiant Bachelor Informatique, dev freelance (SaaS/apps/sites), créateur de ConvoyDoc
- Statut : R1 fait le 16 septembre 2026 (visio), R2 booké dimanche 21 septembre 11h. Conversation menée par Matthias directement (post-31 août, méthode Yann, hors moteur IA `SKILL_SETTING_DM.md`).
- Deux activités bien distinctes chez lui : (1) ConvoyDoc, son app pour convoyeurs automobile — ~150 comptes créés, vient de sortir les abonnements payants (~200€ MRR, 400€ le mois prochain avec un abonnement annuel) ; il veut que ça devienne un side project qui tourne seul. (2) Son activité principale visée : dev freelance généraliste, construit des SaaS/apps/sites/outils sur-mesure pour des entreprises/entrepreneurs — **c'est le sujet de l'accompagnement, jamais ConvoyDoc.**
- **Statut ICP/offre côté Léni, révélé en R1 : aucune offre packagée, aucune niche choisie, aucun prix fixe.** Approche 100% sur-mesure ("comprendre le projet, la douleur, puis voir ce que je peux faire"). A déjà facturé un site à 500€ (avec paiements intégrés), a vu des agences concurrentes facturer 1500€+ pour du vitrine avec preuves solides, négocie actuellement un SaaS qui pourrait valoir 7000€+ (pas closé, rendez-vous décalé à dimanche). Aucune vraie preuve/résultat solide à ce jour selon lui-même ("il n'y a pas énormément de preuves").
- **Vrai blocage identifié par lui-même en R1 : il ne sait pas QUI cibler, pas comment aborder.** Utilise de l'IA pour les premiers DM à froid, pas de méthode. Précise lui-même que le flou n'est pas "comment aborder" mais "qui chercher" en premier lieu.
- Signal positif révélé en R1 : un post à ~40 000 impressions (son seul post viral) a généré un lead entrant réel — un visiteur de profil l'a DM directement pour un projet SaaS (c'est le prospect en négociation actuelle à 7000€+). Objection soulevée par Léni lui-même : les gens qui interagissent sur ses posts sont surtout "du même milieu" (autres devs), pas des clients potentiels directs — à retraiter en stratégie de tri au sein d'une audience de visibilité, pas en signal d'échec du canal.
- Temps disponible : révisé à la hausse en R1 par rapport aux 80% déclarés en DM — dit avoir "100% de son temps" hors ConvoyDoc (école peu prenante, soirs et week-ends libres), mais reconnaît lui-même être encore trop focus sur ConvoyDoc actuellement plutôt que sur l'activité agence.
- Détermination : 10/10 sur le projet agence à long terme, mais dispersion actuelle avec ConvoyDoc reconnue par lui-même comme un frein réel (pas juste un manque de temps).
- **Budget — cas "pas encore là mais piste claire" (cf. `PREP_APPEL_LENI.md`) :** confirme en R1 le <500€ déjà connu en DM, situe le chemin vers le budget via le MRR de ConvoyDoc et/ou le prospect SaaS (7000€+) en négociation. Objectif énoncé par lui-même : closer ce SaaS fin septembre, puis viser 1-2 clients supplémentaires en octobre pour ses premières preuves.
- **Stratégie upfront pour le closing du R2 (call Yann, 19 septembre 2026 — voir `STRATEGIE_YANN.md`, séance du 19 septembre) :** le contrat ne mentionne plus de paiement en plusieurs fois (retiré, voir `CONTRAT_ACCOMPAGNEMENT.md`) — ne pas évoquer de soi-même un paiement échelonné. Léni avait dit en amont pouvoir lâcher 500€ tout de suite, avec un MRR ConvoyDoc qui doit passer à ~400€/mois en octobre ; consigne de Yann : creuser ce qu'il a réellement disponible plutôt que d'accepter cette première somme, viser un upfront plus proche de 700-800€, le reste étant négocié au cas par cas et facturé sur octobre si besoin (Léni n'ayant pas de charges externes, ce n'est pas bloquant pour Matthias). Signature du contrat à obtenir dès le R2, engagement immédiat, indépendamment du montant exact réglé upfront.
- Matthias a validé en fin de R1 : "tu corresponds parfaitement au type de personne que je peux accompagner" — fit confirmé en l'état, malgré le non-fit initial sur les critères stricts de l'avatar Lucas (offre non validée/vendue plusieurs fois, absence d'audience construite, `STRATEGIE_YANN.md`). Matthias a engagé verbalement dès le R1 que l'accompagnement retravaillera cible/offre/tarif avant toute prospection ("si on n'a pas cette base solide, ça sert à rien d'aller prospecter des gens") — engagement à tenir concrètement au R2.
- Contexte donné par Matthias à Léni en call : accompagne une quinzaine de personnes depuis ~1 an, offre actuelle (2000€/3 mois avec garantie de résultat) lancée depuis 3 mois seulement, suite au constat que le mono-produit sans coaching/suivi WhatsApp ne produisait pas de résultats chez les clients.
- Patterns utilisés : Phase 1-2 `METHODE_SETTING_YANN.md` en DM, puis script R1 complet `STRATEGIE_YANN.md` en call (cadrage, situation personnalisée deux activités, question filtre "pourquoi cet appel", creusage offre/prix avant objectif chiffré, budget/preuves adressés en anti-vente).
- **Piste ICP pour le R2, suggérée par Yann (19 septembre) :** resserrer Léni sur le ciblage SaaS plutôt que de disperser sur SaaS/applis/sites — s'appuyer sur le cas Julien Robert (client de l'équipe Yann, 27 000€ en 50 jours en ciblant les SaaS). Reste à creuser avec Alban avant le R2, pas encore une méthode documentée.
- **Plan de closing R2 (call Yann, 19 septembre 2026 — voir `STRATEGIE_YANN.md`, "Notes opérationnelles annexes") :**
  1. Qualifier au niveau du prix : demander ce qu'il peut lâcher maintenant, puis creuser au-delà du premier chiffre annoncé (checker ce qu'il a réellement disponible, quand rentre son MRR ConvoyDoc). Ne pas viser mécaniquement 666€ (tiers de l'ancien échéancier) — viser 800€ upfront, 700€ en repli. Ce qui compte est le montant de l'engagement upfront, pas le nombre d'échéances.
  2. Ne jamais évoquer par écrit un paiement en plusieurs fois précis (contrat corrigé en ce sens, `CONTRAT_ACCOMPAGNEMENT.md` Article 4) — la répartition se négocie à l'oral uniquement.
  3. Signature du contrat obligatoire en direct pendant l'appel (`CONTRAT_ACCOMPAGNEMENT.md`, version PDF prête pour SignWell), même si Léni n'a pas la totalité de la somme disponible immédiatement.
  4. Annoncer que le démarrage concret (première session d'onboarding) a lieu la semaine suivante plutôt qu'immédiatement — motif : Matthias monte en charge de clients, veut faire un onboarding correct. Le paiement upfront et la signature restent immédiats ; seul le démarrage opérationnel est décalé.
  5. Mettre en place la vidéo hebdo obligatoire (bilan chaque vendredi, même système que le rituel Matthias/Yann) — prévoir un rappel/alarme pour que Léni la fasse sans avoir à le redemander.
- Prochaine étape : R2 dimanche 21 septembre 11h — dérouler le plan de closing ci-dessus.
...
### 22/07/2026 — Le plafond tarifaire (publié, Approche 2 Normale)
- Format : post
...
### 25/07/2026 — Tour de France, double ascension Alpe d'Huez (actualité hors ICP, publié samedi 25/07)
- Format : post
...
- Stats (mise à jour 29/07/2026) : 9 réactions, 7 commentaires, 962 impressions (contre 497 relevé le 26/07 — quasi doublé en 3 jours, meilleure performance du lot analysé le 29/07).
- Notes : post choisi pour la cadence week-end (samedi 25/07, voir `SKILL_STRATEGIE.md` Partie 5 — pas de post-référence un jour à faible trafic). Itéré en plusieurs passes avec Matthias jusqu'à validation finale : (1) espacement paragraphe par paragraphe, signal humain/IA distinct de "la phrase ne se hache pas" ; (2) charnières analytiques ("ce qui me plaît", "ça me parle") remplacées — nuance : les charnières physiques/viscérales ("ça me fait marrer") passent, pas les analytiques ; (3) vocabulaire/texture calqués sur Rattrapage Posts #1 (présent de narration, minuscule stratégique de continuation, marqueurs de tangente "Tiens d'ailleurs"/"Bon ok next", élongation de lettre "brefff") ; (4) ouverture recorrigée en scène incarnée avec antagoniste nommé (Pogačar) au lieu d'exposition statistique ("des centaines de coureurs depuis que le Tour existe") ; (5) fragment parallèle nu ("zéro plan, zéro recul") enveloppé dans une phrase sujet/verbe pour casser l'effet construit. Toutes les règles capturées dans `SKILL_CONTENU_LINKEDIN.md`. Version finale validée par Matthias archivée dans `ARCHIVE_CONTENU.md`. Performance confirme le pattern actualité hors-ICP + vécu perso (dépasse finalement le plafond tarifaire du 22/07 en tenant la distance, 1401 impressions) — meilleur post texte du lot analysé le 29/07, voir `SKILL_CONTENU_LINKEDIN.md` (Patterns de performance, confirmation vidéo vs texte du 29/07).

### 25/07/2026 — Sondage feast or famine (PA-1, publié dimanche 26/07)
- Format : post (sondage natif)
...
- Stats (29/07/2026) : 160 impressions, 1 réaction, 5 commentaires, 9 votes (🔥 Plein 11% / Ça tourne bien 11% / Calme un peu inquiet 22% / Sec zéro visibilité 56%).
- Notes : choisi pour la cadence week-end (dimanche 26/07). PA-9 et PA-10 écartés pour ce sondage car déjà couverts récemment par des posts complets (voir entrées 22/07/2026), risque de redite trop rapprochée. Matthias se dit "vraiment satisfait" de celui-ci — pas sur le reach (160 impr, faible) mais sur le fait que 56% des votants aient osé avouer publiquement "sec, zéro visibilité" : lu comme un signal de confiance installée par le contenu récent, plus qu'un outil de reach. Confirme le rôle du sondage décrit dans `SKILL_CONTENU_LINKEDIN.md` (Sous-format Sondages) — qualification/lien, pas performance brute.
...
- Mécanisme : catalogue SA-5 (Débunker la prospection), thème jamais traité en vidéo ni en post à ce jour. Reprend une conviction déjà évoquée par Matthias par le passé (pas récemment) — signalé par lui-même à la lecture du brief, mais jugé suffisamment espacé pour ne pas être une redite, angle jugé bien trouvé. À l'exécution, Matthias a structuré la vidéo en étapes explicites (étape 1 créer la relation, étape 2 poser des questions de plus en plus profondes).
- Stats (26/07/2026) : 11 réactions, 2 commentaires, 96 impressions. Mise à jour 29/07/2026 (engagement, pas de nouveau chiffre d'impressions capturé) : 13 réactions, 2 republications.
- Notes : premier test du nouveau format de brief vidéo (2-3 bullets max, zéro jargon, voir correction du 25/07 dans `SKILL_CONTENU_LINKEDIN.md`) qui a fonctionné — Matthias a su l'amener sans script. Performance sous la moyenne vidéo indiquée par Matthias (100-170) et loin du seul autre point de comparaison chiffré à ce jour (Rattrapage vidéo #19, 277 impressions) — deuxième donnée de perf réelle sur le format vidéo, encore trop tôt pour conclure sur la cause (sujet, exécution ou format lui-même) mais le format vidéo reste sous-performant sur les 2 points de data disponibles. Voir aussi la confirmation à plus grande échelle du 29/07/2026 dans `SKILL_CONTENU_LINKEDIN.md` (Patterns de performance) : sur un lot de 4 vidéos analysées ensemble, toutes plafonnent sous 185 impressions.

### 26/07/2026 — Photo billets, bait sincère "argent facile" (PB-3 Angle 4, publié ~28/07)
...
- Stats (29/07/2026) : 248 impressions, 9 réactions, 17 commentaires, 2 republications.
- Notes : 3 approches livrées (clivante, normale, Mathis Clouet), texte intégral dans `ARCHIVE_CONTENU.md`. Matthias juge lui-même la perf "plutôt bien mais pas exceptionnel". Le même visuel (billets en main) réutilisé quelques jours après dans la vidéo "persévérance" (voir entrée 27/07/2026 ci-dessous) flanche à 65 impressions — voir le pattern "gimmick visuel qui s'épuise" capturé le 29/07/2026 dans `SKILL_CONTENU_LINKEDIN.md` (Patterns de performance).

### 26/07/2026 — Humour/GIF, taux de réponse ex vs DM (PB-4, publié mardi 28/07)
...
- Stats (29/07/2026) : 125 impressions, 1 réaction, 2 commentaires.
- Notes : **planning confirmé** — publié en plus du post SA-4 le même jour (mardi 28/07). Matthias juge que ça a "moyennement marché" — un commentaire jugé rigolo mais peu de réaction globale, cause pas tranchée (sujet, algorithme, ou saturation humour ce jour-là avec le post SA-4 en parallèle).

### 26/07/2026 — Sondage croyance centrale, 5 stratégies comparées (SA-1, publié lundi 27/07)
- Format : post (sondage natif)
...
- Stats (29/07/2026) : 134 impressions, 1 réaction, 7 votes (Contenu 29% / Prospection directe 29% / Bouche à oreille 43% / Pub ou tunnel 0%).
- Notes : thème jamais testé en sondage. Écarté volontairement : PA-1 (utilisé dimanche 26/07), PA-9/PA-10 (déjà couverts par des posts complets récents), SA-4 (post complet prévu mardi 28/07) — pas de redondance avec la semaine en cours. Donnée de segmentation utile : 43% des votants créditent encore le bouche-à-oreille comme source principale — cohérent avec la Croyance Centrale (`SKILL_STRATEGIE.md` Partie 2), ce segment reste à convaincre en priorité. Faible reach (134 impr) mais c'est un sondage diagnostic, pas conçu pour driver du volume.

### 26/07/2026 — Volume avec intention, 110 demandes/semaine (SA-4, Angle 1, réécrit par Matthias, publié mardi 28/07)
- Format : post
...
- Stats (29/07/2026) : 214 impressions, 7 réactions, 3 commentaires.
- Notes : moment de calibrage majeur sur le Ton & Voix — nuances capturées dans `SKILL_CONTENU_LINKEDIN.md` (points de suspension à longueur extrême en clôture, distribution asymétrique des emojis, parenthèses d'aparté, mise en garde sur la sur-utilisation de l'Approche 3/Mathis Clouet). Le "zéro client" mentionné est un fait réel déjà documenté (`CLAUDE.md`, Parcours), pas un chiffre inventé. Matthias juge la perf "plutôt bien", "plutôt satisfait" — cohérent avec SA-4 (régularité + intention > volume aveugle), le post illustre littéralement la thèse qu'il porte.
...
### 27/07/2026 — Persévérance ≠ certitude, la vraie question avant de persévérer (PA-5/SA-1, vidéo, tournée et publiée ~28/07)
- Format : vidéo
- Angle retenu (co-construit avec Claude sur plusieurs itérations, brief long) : hook second degré (billets jetés au sol avec mépris, "voilà ce que j'ai gagné hier, deux mille balles, c'est presque trop facile de gagner de l'argent sur LinkedIn aujourd'hui") → bascule sérieuse → question posée cash : "comment tu sais si tu dois persévérer sur ta stratégie ?" → reframe : le vrai problème c'est jamais le manque de persévérance, c'est l'incertitude — si on change de stratégie tous les trois matins (Matthias le premier), c'est pas de l'impatience, c'est de jamais avoir été sûr que c'était la bonne → bref ancrage perso : le temps qu'il a mis à se poser cette question, à changer de stratégie avant de trouver celle qui tient (facette neuve du parcours, distincte de l'arc coaching 1500€/8 mois gratuit déjà sur-exploité) → révélation : une fois qu'on a trouvé LA stratégie où on peut être sûr que ça marche dans tous les cas (mécanique, pas dépendante d'un tiers/algorithme/chance), la persévérance devient évidente → nomme la prospection directe avec intention comme cette solution stable, assumé cette fois (pas caché en socratique comme en DM, cohérent avec la doctrine posts : montrer son parcours et ce qui a vraiment marché, `SKILL_STRATEGIE.md` Partie 2)
- Mécanisme : combine PA-5 (dispersion stratégique, jamais traité jusqu'ici, catalogue `SKILL_CONTENU_LINKEDIN.md`) et SA-1 (croyance centrale) sous un angle neuf — le pivot stratégique répété reformulé comme symptôme d'incertitude, pas de manque de discipline. Jamais formulé ainsi avant.
- Notes : nombreuses pistes écartées en cours de route avant validation — storytelling classique (déjà fait, client bouche-à-oreille/zéro client du jour au lendemain), tarif/qualité client (jugé pas assez puissant par Matthias), simple conscientisation "il faut un système" (jugée obsolète pour cette audience déjà Solution Aware, voir note `SKILL_CONTENU_LINKEDIN.md` PA-5), approche 100% socratique implicite façon DM (jugée insuffisamment directe pour clore le débat en vidéo). But explicite de Matthias : que le spectateur se dise "purée, c'est ça qu'il faut que je fasse, y'a pas de débat" à la fin.
- Stats (29/07/2026) : 65 impressions, 4 réactions. Titre publié : "C'est devenu trop simple de faire de l'argent sur LinkedIn en 2026…."
- Notes perf : flop net selon Matthias lui-même ("dinguerie ça floppe"), sans qu'il se souvienne du fond exact au moment de commenter — il en tire que "l'ostentatoire pour l'ostentatoire, ça ne marche pas". Le même visuel billets réutilisé une 2e fois (1ère fois : post "2000 balles", 248 impr, voir entrée 26/07/2026 ci-dessus) — cause probable : gimmick visuel épuisé à la 2e occurrence plutôt qu'un problème de fond sur l'angle persévérance lui-même. Voir pattern capturé le 29/07/2026 dans `SKILL_CONTENU_LINKEDIN.md` (Patterns de performance).

### ~27/07/2026 — Vidéo "Arrêtez d'écouter les gens qui parlent de prospection" (nouvelle entrée, ajoutée le 29/07/2026)
- Format : vidéo
- Fragment disponible : "Arrêtez d'écouter les gens qui vous parlent de prospection !! Écoutez bien ce que je dis à la place 👇" — texte intégral non collé dans cette conversation, seule la stat + le fragment de caption sont disponibles, pas d'archivage complet possible dans `ARCHIVE_CONTENU.md` pour l'instant.
- Stats (29/07/2026) : 184 impressions, 7 réactions, 3 commentaires, 3 republications.
- Notes : Matthias satisfait du format ("Ça c'est une vidéo ça") sans détailler pourquoi. Performance dans la moyenne basse vidéo (100-170 indiqué par Matthias), cohérente avec le pattern vidéo sous-performante confirmé le 29/07/2026 (`SKILL_CONTENU_LINKEDIN.md`, Patterns de performance).

### ~28/07/2026 — Vidéo "Si vous avez des problèmes avec vos clients" — bouche à oreille vs prospection (nouvelle entrée, ajoutée le 29/07/2026)
- Format : vidéo
- Fragment disponible : "Si vous avez des problèmes avec vos clients, écoutez cette vidéo 👇" — texte intégral non collé, seul le fragment + les stats sont disponibles.
- Mécanisme (résumé par Matthias) : argumente que le bouche-à-oreille amplifie le problème plutôt que de le résoudre — clients qui ne connaissent pas Matthias, moins investis, plus lents à répondre, plus exigeants — contrairement à un prospect qui arrive via la prospection/contenu, déjà en confiance. Recoupe PA-1 Angle 4 du catalogue (`SKILL_CONTENU_LINKEDIN.md`, "pourquoi le bouche-à-oreille amplifie le problème") mais en vidéo.
- Stats (29/07/2026) : 85 impressions, 2 réactions, 2 commentaires, 1 republication.
- Notes : Matthias juge que ça a "moyennement marché". 3e vidéo du lot analysé le 29/07 sous les 185 impressions, renforce le pattern vidéo sous-performante.

### ~28/07/2026 — "Ma chienne performe mieux que ma stratégie de contenu" (PB-4, nouvelle entrée, ajoutée le 29/07/2026)
...
- Mécanisme : coup de gueule appuyé sur un DM réel reçu par Matthias le jour même (capture d'écran) — un prospecteur affirme avoir "déjà préparé une analyse" pouvant ajouter 3K€/mois, Matthias répond "Va y", reçoit 25 min après un vocal de 44 secondes au lieu de l'analyse promise, répond "Honnêtement flemme de répondre". Le vrai reproche identifié après 3 itérations de brief avec Matthias (pas l'absence de questions en soi, mais le mensonge de prétendre le travail déjà fait pour appâter) — angle proche de SA-3 Angle 4 (posture du médecin, diagnostiquer avant de prescrire) mais recentré sur l'honnêteté du hook plutôt que sur la mécanique de qualification. Texte intégral archivé dans `ARCHIVE_CONTENU.md`.
- Stats (confirmées le 14/08/2026) : 10 686 impressions, 20 réactions, 18 commentaires, 2 republications — meilleure perf du lot reçu le 14/08.
- Notes : angle vérifié absent du corpus avant génération. Brief initial mal compris deux fois par Claude (d'abord recentré à tort sur "pas de questions posées", puis sur des guillemets que Matthias a explicitement refusés) avant la version validée ci-dessus — à garder en tête : nommer le fait concret (prospection, DM, vidéo/analyse qui miroite) sans guillemets stylisés autour des citations reformulées. Confirme le pattern déjà noté (post "signe un client", 04/08) : un incident réel et frais surperforme largement le contenu générique.
...
- Mécanisme : 2e angle sur le thème PB-3 "impressions vs engagement" (1er angle = post du 01/08, progression de ses propres stats) — cette fois basé sur le ratio interactions/impressions comme signal de qualité d'audience, avec comparaison directe aux top voices (100-300 likes mais ~200 000 impressions derrière, contre 47 likes/1700 impressions sur son propre dernier post). Matière brute = note vocale de Matthias, retranscrite et harmonisée. Signalé à Matthias comme angle voisin du post du 01/08 (pas encore publié) avant génération — pas d'objection, traité comme 2e angle distinct plutôt que doublon. Texte intégral archivé dans `ARCHIVE_CONTENU.md` — chiffres de comparaison changés à la publication (300 likes/200 000 impr → 200 likes/90 000 impr).
- Stats (confirmées le 14/08/2026) : 278 impressions, 8 réactions, 1 commentaire, 0 republication — performance modeste malgré le thème méta habituellement porteur.
...
- Format : post
- Accroche finale : "Avant de connecter avec un prospect, je vérifie ces 4 critères précis…" (Approche 1 Clivante, entièrement réécrite phrase par phrase par Matthias — texte intégral dans `ARCHIVE_CONTENU.md`).
- Mécanisme : premier post du catalogue Product Aware (PR-2) publié dans le nouveau pipeline depuis le pivot ICP du 22/07 — comble un trou identifié en session stratégie (aucun post PR- depuis un mois, malgré la fréquence cible 1/10-14 jours, alors que la prospection vient d'être relancée le 5/08). Détaille les 4 critères réels de sourcing (CA généré même modeste/irrégulier, minimum 6 mois d'activité dans la version finale — vérifier avec Matthias si ça pivote le plancher 4-6 mois de l'ICP ou si c'est un choix propre à ce post, activité LinkedIn réelle — poste + commente, offre déjà définie), directement issus de l'ICP pivoté (`CLAUDE.md` Partie 2) et de la méthode sourcing (`SKILL_STRATEGIE.md` Partie 4). 3 approches livrées (clivante, normale, Mathis Clouet) — Approche 1 retenue et réécrite en direct par Matthias, comparaison ligne à ligne capturée dans `SKILL_CONTENU_LINKEDIN.md` (section "Retour du 09 août 2026").
- Stats (confirmées le 14/08/2026) : 95 impressions, 4 réactions, 0 commentaire, 0 republication.
...
- Format : post
- Accroche finale : "Le marché n'est pas saturé, ton offre n'est pas nulle, tu n'as juste pas assez bossé !!" (Approche 1 Clivante, réécrite par Matthias — texte intégral dans `ARCHIVE_CONTENU.md`).
- Mécanisme : premier post complet sur PA-1 Angle 1 (jusqu'ici traité seulement en sondage le 26/07) — brief donné directement par Matthias sous forme de thèse déjà formulée (malchance/marché saturé/offre pas bonne comme excuses, vs manque de travail/persévérance/remise en question/tracking comme vraie cause). Registre clivant, attaque un persona précis (celui qui blâme l'extérieur) — même mécanisme que Rattrapage Posts #7 (meilleur volume de commentaires du corpus). Dans sa réécriture, Matthias a coupé le 4e axe (tracking) et la chute perso (dispersion/manque de consistance) prévus au brief initial — le post final ne couvre que 3 axes (bossé/persisté/remis en question), voir leçon capturée dans `SKILL_CONTENU_LINKEDIN.md` (section "Retour du 09 août 2026 (bis)"). 3 approches livrées (clivante, normale, Mathis Clouet) — Approche 1 retenue et réécrite en direct par Matthias.
- Stats (confirmées le 14/08/2026) : 91 impressions, 4 réactions, 2 commentaires, 0 republication.
...
- Mécanisme : premier post d'opinion politique/société pur du corpus, sans lien business (contrairement au post Tour de France du 25/07 qui gardait un fil vers le vécu perso) — antagoniste nommé directement (Macron) dès les premiers mots, sur demande explicite de Matthias, en 2 itérations (d'abord "veut", corrigé en "c'est acté/met en place" pour un ton plus affirmatif). Angle : ne pas s'opposer à l'objectif affiché (protéger les mineurs) mais démonter le mécanisme (vérification d'âge = vérification d'identité généralisée). Texte intégral archivé dans `ARCHIVE_CONTENU.md`.
- Stats (mise à jour 24 août 2026) : 15 529 impressions, 31 réactions, 60 commentaires, 3 republications (contre 6 883 impr / 18 réactions / 20 commentaires / 2 republications relevé le 14/08 — plus que doublé en 10 jours).
- Notes : signalé une fois à Matthias avant génération (pattern de performance mitigée des posts hors-ICP sans lien business dans ce corpus, voir synthèse Rattrapage Posts) — Matthias a maintenu la demande, exécuté tel quel. Résultat dément clairement l'hypothèse de perf mitigée sur ce territoire — meilleure perf impressions de toute la semaine du 24/08 avant le post "brokie" (voir plus bas), et la meilleure perf confirmée sur la durée (continue de grossir bien après publication, contrairement à la plupart des posts du corpus qui se stabilisent en 3-5 jours). Pas de code catalogue existant (PA/SA/PR/PB) — nouveau territoire "actualité/société" qui a maintenant 2 points de donnée forts (celui-ci + Tour de France 25/07, 962 impr) : à formaliser en entrée de catalogue dans `SKILL_CONTENU_LINKEDIN.md` si Matthias veut en refaire.

### [Reçu 14/08/2026] — post — Le reach n'a pas baissé, c'est toi qui manques d'expérience (faux hook)
- Format : post
- Stats : 291 impressions, 4 réactions, 4 commentaires, 0 republication.
- Notes : post non drafté en session Claude (écrit en autonomie par Matthias, pas d'entrée préexistante). Premier usage du faux hook dans le corpus ("le reach a baissé... je déconne") avant de basculer sur le vrai message (excuses vs manque d'expérience). Texte intégral dans `ARCHIVE_CONTENU.md`.

### [Reçu 14/08/2026] — post — J'ai donné à Claude plus de 90 de mes posts (méta, usage IA)
- Format : post
- Stats : 223 impressions, 2 réactions, 0 commentaire, 0 republication.
- Notes : post non drafté en session Claude. Premier post qui rend public l'usage réel de Claude comme outil d'analyse de patterns de contenu (écho `SKILL_STRATEGIE.md` Partie 11, Vision IA) — cohérent avec le Principe #7 (montrer COMMENT il bosse). Texte intégral dans `ARCHIVE_CONTENU.md`.

### [Reçu 14/08/2026] — post — Traquer avec précision les composantes de son business (méta, data-driven)
- Format : post
- Stats : 156 impressions, 5 réactions, 1 commentaire, 1 republication.
- Notes : post non drafté en session Claude. 2e post méta/data-driven du lot, thème proche de `SKILL_STRATEGIE.md` Partie 9 (KPIs). Texte intégral dans `ARCHIVE_CONTENU.md`.

### [Reçu 14/08/2026] — post — Le vrai coût d'un client chronophage (taux horaire)
- Format : post
- Stats : 282 impressions, 6 réactions, 4 commentaires, 0 republication.
- Notes : post non drafté en session Claude. Nouvelle anecdote (client qui paie bien mais bouffe le temps en appels/messages, taux horaire réel ~8€/h) jamais posté avant — matériau réutilisable pour un futur post/catalogue "prix ne détermine pas la valeur du client". Texte intégral dans `ARCHIVE_CONTENU.md`.

### [Reçu 14/08/2026] — sondage — Qualité vs quantité vs tracking, priorité business
- Format : sondage
...
- Stats (24 août 2026) : 176 impressions, 9 réactions, 0 commentaire.
...
### 14/08/2026 — Contenu et prospection-commentaires, le même mécanisme (SA-7, nouvelle entrée catalogue, Angle 1)
- Format : post
- Accroche : "Je parle plus à certains prospects sous leurs posts qu'en message privé."
- Mécanisme : 2e sujet de la paire donnée par Matthias dans la même session (voir entrée SA-6 juste au-dessus) — nouvelle entrée catalogue Solution Aware, prolonge SA-2 (angle "commenter avant de connecter") en posant l'équivalence complète : le contenu posté et les commentaires laissés chez les autres visent la même fonction (visibilité, relation, éducation), tout le monde met en avant la phase message privé, personne la phase commentaires qui construit la relation en amont. Point de vigilance en session : le brief initial de Matthias ("et c'est ça qui me permet d'avoir plus de clients en ce moment") a été signalé avant génération car il constituait une affirmation de résultat non confirmée (Principe #2, `SKILL_STRATEGIE.md` — dernier statut connu au 5 août, 0 client signé sur l'offre 2000€, rien confirmé depuis) ; Matthias a clarifié qu'il ne s'agissait pas d'une phrase à reprendre littéralement mais du sens/de la conviction à faire ressortir (personne ne met en avant la phase commentaires). Aucun chiffre ni statut de résultat inclus dans les 3 approches. 3 approches livrées (clivante, normale, Mathis Clouet). Texte intégral à archiver dans `ARCHIVE_CONTENU.md` une fois l'approche choisie confirmée.
- Stats (24 août 2026) : 65 impressions, 3 réactions, 0 commentaire.
- Notes : à ajouter au catalogue SA (`SKILL_CONTENU_LINKEDIN.md`) comme SA-7 une fois l'approche validée et publiée. Plus faible reach du trio de posts du 14/08 (SA-3 écoute, SA-6 conversion, SA-7 ici) — les trois tournent autour du même mécanisme contenu/prospection sur une fenêtre courte, redite possible malgré les angles différenciés.
...
- **Rejeté par Matthias (18/08/2026) :** sujet ET design refusés. Sujet jugé "éclaté au sol" — un tableau comparatif informatif n'a aucune tension, le lecteur devine déjà la suite, rien ne pousse à swiper jusqu'au bout. Design jugé "trop sec, pas assez joli" — palette ambre/noir hors charte. Charte réelle de Matthias (capturée depuis sa bannière LinkedIn) : noir/navy + blanc + bleu uniquement, esthétique glow/pilules arrondies façon vaisseau spatial, jamais d'autre couleur d'accent. Remplacé par l'entrée suivante.

### 18/08/2026 — 3 signaux qu'un prospect va être un cauchemar à accompagner (red flags closing, carousel, nouveau territoire de contenu)

- Format : carousel LinkedIn (7 slides, PDF 1080x1350px) + texte d'accompagnement.
- Accroche du texte d'accompagnement : "Y'a 3 trucs qu'un prospect peut dire en appel de closing qui me font ralentir, direct."
- Mécanisme : sujet proposé par Claude parmi 3 pistes (auto-diagnostic PA-1/PA-9/PA-10, ce sujet, storytelling PB-2 des 4 erreurs), choisi par Matthias. Contenu tiré des "Red Flags Prospect" de `SKILL_STRATEGIE.md` Partie 6 (closing) — jamais publié en contenu jusqu'ici, aucune entrée catalogue `SKILL_CONTENU_LINKEDIN.md` ne le couvre encore. Classé Personal Brand / opinion tranchée (PB-3) plutôt que Product Aware : partage un insight/mécanisme de closing sans exposer de résultat chiffré, ce qui évite aussi la cadence Product Aware (1 post/10-14j, dernier PR le 09/08, encore trop proche). Structure : cover + 1 slide de cadrage + 3 signaux (un par slide, verbatims exacts de la doctrine : blâme des anciens formateurs, insistance sur la garantie, paiement en x10/x12) + 1 slide payoff ("un prospect te montre toujours comment il va se comporter après la vente") + close. Aucun chiffre inventé, aucune anecdote/client fictif ajouté (les red flags restent formulés comme règle générale, pas comme incident daté, pour ne pas fabriquer une situation client qui n'a pas eu lieu). Design refait entièrement : fond navy dégradé avec halos bleus et grain étoilé, pilules outline avec point lumineux bleu pour les labels, pilule pleine dégradé bleu avec glow pour le mot-clé de l'accroche — première application concrète de la charte "noir/blanc/bleu, esthétique glow" en dehors des bannières.
- Stats : pas encore publié.
- Notes : format carousel toujours non documenté dans `SKILL_CONTENU_LINKEDIN.md` — à faire si Matthias valide définitivement ce sujet/design et veut industrialiser le format. Texte intégral + détail des 7 slides à archiver dans `ARCHIVE_CONTENU.md` si publication confirmée.
- **Mise à jour (18/08/2026) — process texte-avant-visuel appliqué pour la première fois, capturé dans `SKILL_CONTENU_LINKEDIN.md` (nouveau sous-format Carousels).** Texte livré page par page avant toute génération d'image ; corrections de Matthias : "3 trucs" → "3 alertes" (accroche + partout dans le texte) ; page 2 (cadrage suspense) fusionnée avec la page 3 (alerte 1) car un cadrage isolé sans contenu était jugé creux ; négation oubliée corrigée ("il n'est jamais vraiment rentré dans l'appel", pas "il est jamais... dedans") ; alerte 3 changée de "x10/x12" (verbatim doctrine `SKILL_STRATEGIE.md`) à "plus de 4 fois" pour rester relatable à l'écrit — ajustement de formulation propre à ce post, pas une modification de la doctrine source ; point remplacé par une virgule avant "pas trois mois plus tard" (page payoff). Carousel passé de 7 à 6 pages après fusion. Design entièrement refait une 2e fois : palette confirmée mais jugée encore "trop Claude" au 1er essai malgré les bonnes couleurs — ajout de profondeur réelle (halos multiples, grain/texture façon bruit fractal en overlay, vignette, glass-pill avec reflet superieur façon bouton glossy) et police Poppins (téléchargée et encodée en base64 dans le HTML pour un rendu offline fiable — le `@import` Google Fonts direct ne se chargeait pas dans le Chromium headless de Playwright malgré un accès réseau fonctionnel en curl, cause probable : le proxy HTTPS de l'environnement n'est pas propagé au processus navigateur). Seul élément conservé du 1er essai : le petit point bleu lumineux dans les pilules de label.

### 20/08/2026 — Le système d'itération continue, "la boucle" (PR-5, nouvel angle catégorie, Angle 1)
- Format : post
- Accroche : "J'ai un système que j'applique sur tout ce que je fais sur LinkedIn, poster, commenter, prospecter, et c'est probablement la vraie raison pour laquelle je n'ai jamais arrêté." (accroche moyenne #8, choisie par Matthias, négation "j'ai jamais arrêté" corrigée en "je n'ai jamais arrêté" avant livraison — voir point de vigilance négations `SKILL_CONTENU_LINKEDIN.md`)
- Mécanisme : premier post du nouveau catalogue PR-5 — montre le process personnel de Matthias (chaque action sur les 3 leviers posts/commentaires/prospection est un test, jamais une répétition à l'identique ; un flop devient une donnée, pas une preuve d'incompétence). Origine : demandé en session stratégie (pôle 1) comme base d'un futur lead magnet en plusieurs posts sur "la boucle" de progression de Matthias — ce post est le premier jalon, pas encore la série complète. Point de vigilance signalé avant génération : un post/vidéo très proche en surface ("voici la solution pour être bon dans son business", 25/07, 59 impr, pire perf du lot) avait flop en présentant le mécanisme de façon abstraite/méta sans scène incarnée — Matthias a clarifié que ce nouveau post vend un PROCESS/SYSTÈME concret de Matthias, pas une leçon générale sur l'itération, distinction actée avant de lancer les accroches. 3 approches livrées (clivante, normale, Mathis Clouet), toutes ancrées en première personne sur les 3 leviers réels (post/commentaire/prospection), aucun chiffre client inventé (uniquement des exemples illustratifs sur son propre process, ex. "post à 60 impressions").
- Stats (24 août 2026) : 120 impressions, 13 réactions, 4 commentaires, 1 republication.
- Notes : reste à choisir l'approche avec Matthias. Nouvelle entrée catalogue PR-5 ajoutée dans `SKILL_CONTENU_LINKEDIN.md`. Si Matthias confirme vouloir enchaîner sur une série de plusieurs posts (le lead magnet évoqué en session stratégie), prévoir la suite ici au fur et à mesure plutôt qu'en un seul bloc. Performance correcte sans être forte — reach modeste mais bon ratio engagement (13 réactions + 1 republication pour 120 impr).
...
- Stats (24 août 2026) : 576 impressions, 11 réactions, 13 commentaires.
- Notes : ton/crédibilité confirmés a posteriori par la performance — nette meilleure perf du corpus sur le sous-format Bait comique (contre le 1er essai retiré avant publication), et l'un des meilleurs ratios commentaires/impressions de toute la semaine du 24/08. Le sous-format Bait comique validé comme efficace sur cette 2e tentative crédible.
...
- Stats (24 août 2026) : 834 impressions, 16 réactions, 19 commentaires.
- Notes : reste à choisir l'approche avec Matthias, puis enchaîner sur le post de dimanche (même carte blanche, même registre humour léger). Bonne performance pour un post court/léger de cadence week-end — 2e meilleur ratio engagement (réactions+commentaires) de la semaine du 24/08 après le post "brokie" et l'objection "j'ai pas l'argent".
...
- Stats (24 août 2026) : 174 impressions, 5 réactions, 3 commentaires.
- Notes : reste à choisir l'approche. Les deux tentatives écartées (Vaya, badminton) ne sont pas perdues — badminton en particulier reste une piste PB-4 valide pour une future session, juste pas retenue cette fois. Performance dans la moyenne du corpus, sans éclat particulier.
...
- Stats (24 août 2026) : 5 292 impressions, 56 réactions, 64 commentaires, 5 republications.
...
- **Corrigé par Matthias (20/08/2026, même jour) :** post initial jugé trop "point de vue omniscient, article", pas assez émotionnel/opinion assumée. Réécrit en 1ère personne avec avis tranché ("ça me gonfle", "ça me rend dingue"). Deux corrections factuelles faites au passage : la France n'est pas la seule en Europe (l'Italie l'a fait dès 2019, retiré de l'angle) ; le chiffre de "300 millions" avancé par Matthias non confirmé par les sources, remplacé par les chiffres réellement sourcés (122M€ + 44M€/an, Dinum). Version finale livrée dans la conversation, publiée.
- **Performance (24/08/2026) : 2e meilleur post de la semaine derrière le post "brokie" (voir plus bas), et très large tête du peloton hors ce cas exceptionnel.** Confirme deux patterns déjà notés dans `SKILL_CONTENU_LINKEDIN.md` : le coup de gueule assumé en 1ère personne surperforme la version "article neutre" initialement écartée, et un sujet administratif concret + chiffré (deadline réelle, montants sourcés) touche large au-delà du cercle ICP strict.

### 20/08/2026 — Sous-format "Subversion ironique courte", 3 exemples proposés (nouveau sous-format Module 1)
...
- Stats (24 août 2026) : le sujet "automatisation IA" (registre : conseil habituel "automatise tout" retourné en ironie — "c'est comme ça que je passe plus de temps à corriger l'IA qu'à faire le travail moi-même") a été retenu et publié — 143 impressions, 3 réactions, 2 commentaires.
- Notes : reste à confirmer avec Matthias si d'autres sujets du lot de 10 seront publiés, ou si un seul suffisait pour tester le sous-format sur ce cycle. Performance faible pour ce premier test du micro-format en usage réel (à comparer aux 2 exemples précédents corrigés le 20/08, jamais publiés) — trop tôt pour juger le sous-format lui-même sur un seul point de donnée.
...
### [Reçu 24/08/2026] — post — L'enthousiasme excessif en DM comme signal de prospection ("t'es sûr à 100% d'être prospecté")
- Format : post
- Accroche : "Si quelqu'un t'envoie un DM avec beaucoup d'enthousiasme, t'es sûr à 100% d'être prospecté !!"
- Stats : 172 impressions, 7 réactions, 4 commentaires.
- Notes : post non drafté en session Claude. Sujet proche de la doctrine de Matthias sur le setting (`TEASING_METHODE_DM.md`, `SKILL_SETTING_DM.md`) — critique de la sur-flatterie en ouverture de DM, appelle à la sincérité plutôt qu'un enthousiasme joué. Angle réutilisable pour le catalogue SA (mécanique de setting) si Matthias veut le formaliser.

### [Reçu 24/08/2026] — post — L'équipe de France est française, point (actualité sport/société, hors ICP)
- Format : post
- Accroche : "L'équipe de France n'est plus l'équipe de France, mais l'équipe d'Afrique…"
- Stats : 2 313 impressions, 6 réactions, 6 commentaires.
- Notes : post non drafté en session Claude. Actualité société/sport pure (victoire de l'équipe de France, débat racisme/nationalité), aucun lien business, registre proche du post Macron du 09/08 (opinion politique/société) — 2e point de donnée sur le territoire "actualité/société" sensible, reach correct sans être fort. Sujet sensible, à ne jamais proposer de soi-même (relève d'un choix personnel de Matthias).

### [Reçu 24/08/2026] — post — Le jeune de 17 ans qui insulte après un "stop" en prospection ("brokie")
- Format : post
- Accroche : "Je me suis fait insulter par un jeune de 17 ans…… juste parce que j'ai dit stop à sa prospection sur LinkedIn."
- Stats : 27 174 impressions, 86 réactions, 251 commentaires, 10 republications.
- Notes : post non drafté en session Claude. **Meilleure performance de très loin du corpus entier à ce jour** — Matthias signale lui-même "une dinguerie à quel point les scores ont pété, les gens se sont déchaînés en commentaire". Mécanisme : anecdote réelle et datée, retournement net ("boss" → "brokie" en une réponse), révèle l'insincérité de la posture initiale — proche du mécanisme déjà identifié sur Rattrapage Posts #33 (relances faussement sincères) mais avec un incident concret et daté plutôt qu'une observation générale, et surtout un point de tension fort (irrespect direct d'un mineur). À analyser plus en détail avec Matthias pour en tirer un pattern réutilisable (incident réel + retournement net + tension relationnelle = fort driver de commentaires), candidat clair pour `SKILL_CONTENU_LINKEDIN.md` (Patterns de performance).

### [Reçu 24/08/2026] — post — Documents bloqués à 100% malgré la fibre (coup de gueule mineur, hors business)
- Format : post
- Accroche : "Qu'est-ce que ça m'énerve quand je dois envoyer des documents à un client et que ça reste bloqué à 100 % pendant plus de 45min, alors que je suis avec la fibre 😠😠"
- Stats : 179 impressions, 3 réactions, 2 commentaires.
- Notes : post non drafté en session Claude. Coup de gueule très court, sans lien business direct (frustration technique pure) — performance faible, cohérent avec le pattern déjà noté que les posts sans enjeu nommé pour l'audience sous-performent.

### [Reçu 24/08/2026] — sondage — "C'est pour un pote", situation actuelle sur LinkedIn
- Format : sondage
- Question : "T'es dans quelle situation aujourd'hui ?" — Options : Je manque de régularité / Je sais pas quoi faire / LinkedIn me fait peur
- Stats (24/08/2026, en cours — 3 jours restants) : 115 impressions, 3 votes (100% "Je manque de régularité" sur l'échantillon actuel).
- Notes : post non drafté en session Claude. Échantillon encore très faible (3 votes), à ne pas surinterpréter avant clôture. Si le résultat se confirme (régularité = frein #1 déclaré), cohérent avec Principe #4/#7 de `SKILL_STRATEGIE.md` (intention + régularité comme différenciateur) — donnée à reprendre une fois le sondage clos.

### [Reçu 24/08/2026] — vidéo — Les faux-culs qui ne tiennent jamais leurs promesses (contrat, virement, "t'inquiète")
- Format : vidéo
- Accroche : "je n'en peux plus des gens FAUX-CUL qui se la jouent cool et honnête, alors que c'est du vent complet….."
- Stats : 1 007 impressions, 9 réactions, 8 commentaires.
- Notes : post non drafté en session Claude. Coup de gueule vécu (retards répétés sur contrats/virements chez des collaborateurs, "9 collaborations sur 10"), ton très cash. Performance vidéo correcte, au-dessus de la moyenne vidéo habituelle du corpus (100-170 impr) — à noter comme contre-exemple au pattern "le format vidéo sous-performe" déjà relevé, si le sujet clivant/vécu explique l'écart plutôt que le format lui-même.
...
- Format : post
- Accroche : "Tu peux être hyper doué dans ton domaine, si personne ne le sait ça sert à rien." (accroche courte #1, validée par Matthias)
- Mécanisme : brief donné en session stratégie (pôle 1) — post léger de cadence week-end (`SKILL_STRATEGIE.md` Partie 5 : jamais de post-pilier samedi/dimanche), généré via le skill `posts-linkedin`. Origine : nuance retenue de la première séance de coaching avec Yann Perono du 27/08/2026 (voir `SKILL_STRATEGIE.md` Partie 11) — opinion tranchée générale (compétence seule ≠ visibilité), volontairement pas construite sur un pain point précis de la cible actuelle de Matthias, conforme au brief de Yann sur les posts clivants de pure visibilité/TOFU. Premier angle proposé (le réflexe de trier ses relations LinkedIn, autre nuance de la même séance) refusé par Matthias avant celui-ci, sans motif précisé — piste écartée, non reprise.
- **Correction de Matthias (28/08/2026, même jour) :** premier jet des 3 approches jugé pas assez clivant — seule l'accroche choisie portait l'intensité voulue, pas le développement. Demande explicite : pointer du doigt directement le lecteur (2e personne accusatoire, pas de l'observation générale à la 3e personne), intégrer un chiffre donné par Matthias lui-même en mode paradoxe ("90% des gens compétents dans leur domaine restent invisibles"), et appliquer ce niveau de dureté aux 3 approches, pas seulement l'Approche 1. Matthias signale que c'est une erreur récurrente ("chaque fois tu fais l'erreur") — **nuance capturée directement dans le skill externe `posts-linkedin`** (fichier `/root/.claude/skills/synced/.../posts-linkedin/SKILL.md`, hors repo, nouvelle section "CALIBRAGE CLIVANT" ajoutée avant la description des 3 approches) pour que ça s'applique par défaut aux prochaines sessions, pas seulement à ce post. 3 approches réécrites avec le chiffre 90% et l'adresse directe "tu/toi" dans les trois registres.
- Stats : pas encore publié.
...
### [Reçu 02/09/2026] — post — Le bouche-à-oreille, chance déguisée en compétence (SA-1, Angle 3)
- Format : post
- Accroche : "Le bouche-à-oreille n'est pas une stratégie. C'est de la chance déguisée en compétence."
- Mécanisme : démontage de croyance (SA-1 Angle 3, catalogue déjà existant, jamais transformé en post complet jusqu'ici) via un pivot qui évite le rejet en bloc du bouche-à-oreille : distinction signal/résultat (réel, bon signe) vs stratégie/système qu'on peut déclencher à volonté (faux, hors de contrôle). Argument central = test de reproductibilité (une compétence se déclenche à volonté, le bouche-à-oreille non — zéro main sur la fréquence/le timing) + biais d'attribution (le succès est crédité au mérite, jamais au hasard du timing/réseau de l'autre). Post d'opinion clivante pure, brief Yann Perono du 27-28/08 (posts TOFU volontairement pas accrochés à un pain point précis de l'ICP) — 2e post de ce type après le PB-3 "faire savoir > savoir-faire" du 28/08. Argumentaire construit en collaboration avec Matthias, structure validée tour par tour avant toute rédaction (accroche + pivot + mécanisme + test + chute), avant de passer aux 8 accroches puis aux 3 approches.
- Stats : pas encore publié.
- Notes : distinct de PA-1 Angle 4 (le bouche-à-oreille amplifie le feast-or-famine, déjà dans le catalogue) — angle différent ici (chance vs compétence, misattribution), pas un doublon. **Mise à jour (02/09/2026) :** Matthias a réécrit l'Approche 1 lui-même (avant/après complet dans `ARCHIVE_CONTENU.md`, leçons dans `SKILL_CONTENU_LINKEDIN.md`) — coupe deux paragraphes entiers (biais d'attribution, scène du réveil) au profit d'un contraste sec + question directe. Une faute d'accord signalée ("déguisé" → "déguisée") et une incohérence de graphie ("bouche à oreille" / "bouche-à-oreille") encore à corriger avant publication.
...
- **2e correction de Matthias (5 août 2026) :** l'option qui demandait "ça tourne bien ton activité freelance ?" rejetée aussi — "trop crâmé que l'apport d'affaires était une excuse pour trouver des leads." Nuance capturée dans `SKILL_SETTING_DM.md` (Règle 12) : juste après avoir décliné un pitch entrant, ne jamais poser une question qui touche même de loin au business/aux clients du prospect, ça expose l'intention réelle et viole le Principe #1 (ne jamais montrer le besoin).
- **3e correction, même échange (5 août 2026) :** les 2 options restantes (callback "à bientôt" + "comment ça va", et check-in neutre) rejetées aussi — un check-in générique sans contenu réel est tout aussi crâmé qu'une question business, ça sonne comme une politesse vide pour garder le fil ouvert. Nouvelle direction donnée par Matthias : demander une vraie précision sur un détail réel déjà évoqué (savoir-faire/passion, jamais business/clients), ou s'intéresser sincèrement avec du contenu spécifique. Appliqué au motion design qu'elle avait mentionné en passant (détail réel, hors business).
- Message envoyé sur le motion design, elle a répondu en détail (attire le regard, différenciation concurrentielle, exemples concrets : pictogrammes/boutons/bandeaux animés) mais reste encore un peu dans un registre de pitch ("Si tu as d'autres questions n'hésite pas"). Ancienneté réelle en UX/UI toujours inconnue (juste "depuis plus longtemps" que ses 6 mois de freelance).
- Patterns utilisés : précision sur un détail réel de son savoir-faire (motion design), jamais business/clients — pattern validé à retenir pour les futures relances post-déclin de pitch. Proposition en cours pour soit approfondir un exemple concret, soit enfin fermer la Phase 1 (ancienneté UX/UI)
...
- Message envoyé, mais mal compris par Jonathan ("j'ai pas compris, le focus suisse ?") — clarifié ensuite : il habite à Genève et apprécie travailler en proximité. Petit couac de formulation sans conséquence.
- Patterns utilisés : R1 (curiosité sur son positionnement géographique sans le qualifier), proposition en cours pour clarifier brièvement puis avancer vers l'ancienneté/parcours
- Prochaine étape probable : envoyer le message choisi par Matthias
- Dernière mise à jour : 5 août 2026
...
- Dernier point : métier détaillé (branding complet + site Framer/Webflow, accompagnement A à Z), ICP connu (artisans/solopreneurs/PME déjà installés qui veulent revoir leur image). Message envoyé aujourd'hui sur le scope solo/collaboratif — il a confirmé bosser tout seul sur toute la chaîne. Ancienneté/parcours encore inconnus.
- Patterns utilisés : R1 (question ancrée sur sa réponse précédente), en attente de proposition pour fermer la Phase 1
- Prochaine étape probable : envoyer le message choisi (ancienneté), puis basculer vers la question pivot Phase 2 (focus/objectif de l'année)
- Dernière mise à jour : 5 août 2026
...
- Dernier point : premier contact par vocal (0:16, contenu non retranscrit), réponse décalée car en vacances, échange léger sur la déconnexion. Dernier message du fil envoyé par Matthias lui-même ("Carrément", emojis) sans question de fin — le fil est en pause côté Matthias, pas côté Charlène. Aucune info business échangée à ce stade, seule matière disponible = sa bio ("Plusieurs vies professionnelles en tête ? On choisit quoi tester en premier • Transition professionnelle").
- **Correction de Matthias (5 août 2026) sur les 3 propositions initiales :** l'option humour pure jugée "catastrophique, beaucoup trop cash pour une des premières questions" (question directe sur son quotidien client sans aucun enrobage). L'option B jugée "déjà mieux mais vraiment pas ça". Version retenue par Matthias lui-même : garder l'accroche légère sur la déconnexion + la question directe sur son quotidien client, mais ajouter une parenthèse juste après la question qui admet une ignorance sincère sur son domaine ("(parce que je connais pas du tout [son expertise])") — capturé comme nouvelle technique dans `SKILL_SETTING_DM.md` (section Ton et style) : une question concrète en Phase 1 s'atténue avec une parenthèse de curiosité sincère placée APRÈS la question, jamais avant.
- Patterns utilisés : nouvelle technique de parenthèse-curiosité (voir ci-dessus)
- Message final validé : "Haha carrément, profites-en bien avant de retourner aider tout le monde à choisir sa prochaine vie professionnelle 😄 ça ressemble à quoi ton quotidien avec tes clients concretement ? (parce que je connais pas du tout la reconversion pro)"
...
- Statut : Étape 6 (Yann) — pain point clair + intérêt exprimé + qualifiée sur l'expérience (3 premières conditions de la Situation 11 réunies), mais **4e condition (capacité financière suggérée par le contexte) pas acquise** — pas de proposition de visio pour l'instant, retour en creusage
- Dernier point : projet en cours de lancement (officialisation visée pour octobre, calée sur le début de trimestre pour garder l'exonération ACRE), garde un mi-temps salarié en parallèle le temps du démarrage. Volume de prospection déjà très élevé et quantifié (5-10 DM LinkedIn/jour, plus de 300 mails avec relances sur 2 mois, appels découverte, contenu régulier, veille IA/outils, tunnels clients). Un seul client à ce jour (mission courte en juin — retour, avis et séances de yoga en échange, pas de paiement cash ni résultat client chiffré documenté ; croyance "avis = résultat" challengée par Matthias). Blocage nommé par Matthias et confirmé implicitement par elle : tout s'arrête avant la conversion (ébauches de discussion, une prescriptrice, un atelier pitch/deck à venir) malgré un objectif clair de 2-3 missions signées d'ici octobre-novembre. Dernier message : elle demande directement "et qu'est-ce que je peux faire d'autre sur ce qui te chiffonne ?"
- **Signal financier à surveiller (2 septembre 2026, nouvelle 4e condition de la Situation 11) :** plusieurs indices vont dans le sens d'une capacité financière encore incertaine — elle compte sur des remplacements salariés à temps partiel pour "assurer un revenu" (le CA freelance seul ne suffit pas encore), elle retarde volontairement l'ouverture de son auto-entreprise tant qu'aucun client n'est signé (pour ne pas perdre l'exonération ACRE sans CA en face), et sa seule mission à ce jour a été réglée en nature (avis + séances de yoga), pas en cash. Aucun signal favorable identifié pour l'instant (pas de mention de formation/coaching payant, de CDI stable, ou d'activité rentable). Décision de Matthias (2 septembre) : ne pas proposer la visio tant que ce signal n'est pas clarifié, même si les 3 autres conditions sont réunies — continuer à creuser plutôt que forcer l'appel.
- Patterns utilisés : Règle 1 (rebond sur ses mots exacts, "chiffonne"/conversion), Règle 6 (quantification du volume et des résultats), Règle 4 (croyance "avis client = résultat client" challengée), Règle 3 (validation avant redirection), Situation 10/Règle 9 (GAP nommé après prise de conscience) — proposition de visio (Situation 11) volontairement différée, capacité financière pas confirmée
- Prochaine étape probable : envoyer une réponse qui valide + nomme le GAP conversion (sans donner la solution, Règle 8) et creuse indirectement l'urgence/le filet de sécurité financier (jamais le budget/prix frontalement, Partie 5 Règle 1) — ex : sa marge de temps avant que la situation devienne tendue vu qu'elle dépend des remplacements. Ne proposer la visio que si un signal financier clair (favorable) apparaît ensuite
