...
- **Objectif de l'appel : vendre son package formation MASE + communauté associée, pas ses services d'accompagnement/audit.** Correction de Matthias (14 septembre 2026) : la formation et la communauté forment un seul package, pas deux produits séparés — elle l'a vendu une fois (pas "une fois chacun"). Toute la conversation juste avant le call obtenu porte sur ce sujet : elle a déjà vendu ce package une fois mais n'a aucun système pour vendre plus, aucune routine de setting/prospection ("je m'y prends pas"). Rien dans l'échange n'évoque un besoin sur son activité MASE core (accompagnement/audit), déjà full et rentable.
...
- Objectifs long terme (donnés spontanément, en cascade à la question de Matthias) :
  ...
  2. Package formation en ligne MASE + communauté — c'est l'objectif du call (voir ci-dessus) : déjà créé et déjà vendu une fois (comme un tout, pas les deux séparément), elle veut maintenant le vendre en volume.
...
- **Le vrai sujet business actuel, à bien distinguer de l'activité MASE core (saine et stable) : son package formation + communauté MASE (lives d'expert, forum, réponses aux questions), vendu comme un tout, pas comme deux produits distincts.** Déjà vendu une fois ("j'ai de la traction ... faut juste que je termine et que je vende plus"). Plan de distribution : la formation sera incluse dans l'accompagnement (le client bosse, elle corrige, gain de temps pour elle) ; aux anciens clients d'audit interne, elle compte vendre soit la formation seule soit la communauté. Canal envisagé par elle-même, spontanément : "posts LinkedIn, refaire un lead magnet, faire du setting, et prospecter un peu."
