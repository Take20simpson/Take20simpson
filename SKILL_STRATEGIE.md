...
- **Roadmap solo (29 juillet) :** document dedie complet cree — `STRATEGIE_POD_SOLO.md` — taille du beta (5 pour demarrer), shortlist des 5 candidats tiree de `JOURNAL.md`, methode d'invitation, nom, canal (Telegram), regles, onboarding, suivi, budget-temps (2-3h/semaine propose), criteres de fin de beta. Premier jet en attente de feedback de Matthias avant execution
